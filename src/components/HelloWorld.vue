    ...
    <nav class="navbar navbar-expand-lg bg-primary">
      <div class="container">
        <a class="navbar-brand text-white" href="#"><img
            src="https://wheelofnames.com/images/logo-dark-background-38.png" style="border-radius: 100%;"
            alt=""><b style="font-size: 28px">  wheelofnames.com</b> </a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText"
          aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" style="justify-content: space-between;" id="navbarText">
       
          
          <ul class="navbar-text d-flex mb-2 mb-lg-0">
            <li class="nav-item d-flex gap-2" style="padding: 0px 14px; align-items: center; color: white; font-weight: 600;">
              ...
              <a class="nav-link active text-white" aria-current="page" href="#">Customize</a>
            </li>
            <li class="nav-item d-flex gap-2" style="padding: 0px 14px; align-items: center; color: white; font-weight: 600;">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width: 24px; height: 24px;">
                <path fill-rule="evenodd"
            ...
            <li class="nav-item d-flex gap-2" style="padding: 0px 14px; align-items: center; color: white; font-weight: 600;">
              ...
              <a class="nav-link text-white" href="#">Open</a>
            </li>
            <li class="nav-item d-flex gap-2" style="padding: 0px 14px; align-items: center; color: white; font-weight: 600;">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width: 24px; height: 24px;">
                <path fill-rule="evenodd"
              ...
              <a class="nav-link text-white" href="#">Save</a>
            </li>
            <li class="nav-item d-flex gap-2" style="padding: 0px 14px; align-items: center; color: white; font-weight: 600;">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width: 24px; height: 24px;">
                <path fill-rule="evenodd"
