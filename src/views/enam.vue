                ...
                <div class=" card w-50 mx-auto text-center bd-radi ">
                  ...
                  <div class="card-body p-4">
                    ...
                    <button type="button" class="btn mx-auto btn-primary text-white">
                      <RouterLink
                    to="/services/randomnamepicker/uniqueidentifier/xyz9876543/generator/chooseyourwinner/selectrandomly/tujuh" class="text-white">Simpan & Putar Kembali</RouterLink>
                    </button>
                  </div>
                </div>
